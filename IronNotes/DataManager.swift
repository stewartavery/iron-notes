...
class DataManager {
  ...
  func setupDefaultData() {
    ...
    let abdominals = MuscleGroup.getMuscleGroupFor(name: "Abdominals")
    _ = MuscleGroup.getMuscleGroupFor(name: "Adductors")
    let biceps = MuscleGroup.getMuscleGroupFor(name: "Biceps")
    let calves = MuscleGroup.getMuscleGroupFor(name: "Calves")
    let pectoral = MuscleGroup.getMuscleGroupFor(name: "Pectoral")
    let forearms = MuscleGroup.getMuscleGroupFor(name: "Forearms")
    let glutes = MuscleGroup.getMuscleGroupFor(name: "Glutes")
    let hamstrings = MuscleGroup.getMuscleGroupFor(name: "Hamstrings")
    let hips = MuscleGroup.getMuscleGroupFor(name: "Hips")
    let lats = MuscleGroup.getMuscleGroupFor(name: "Lats")
    let lowerBack = MuscleGroup.getMuscleGroupFor(name: "Lower Back")
    _ = MuscleGroup.getMuscleGroupFor(name: "Middle Back")
    _ = MuscleGroup.getMuscleGroupFor(name: "Neck")
    let quadriceps = MuscleGroup.getMuscleGroupFor(name: "Quadriceps")
    _ = MuscleGroup.getMuscleGroupFor(name: "Shoulders")
    _ = MuscleGroup.getMuscleGroupFor(name: "Upper Back")
    let traps = MuscleGroup.getMuscleGroupFor(name: "Traps")
    let triceps = MuscleGroup.getMuscleGroupFor(name: "Triceps")
    let deltoids = MuscleGroup.getMuscleGroupFor(name: "Deltoids")
